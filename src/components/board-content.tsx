...
// import SuperNotebookElement from '@/components/canvas/elements/Old_super-notebook-element'; // DESACTIVADO TEMPORALMENTE
import TestNotepadElement from '@/components/canvas/elements/test-notepad-element';
...
import AccordionElement from '@/components/canvas/elements/accordion-element';
import TabbedNotepadElement from '@/components/canvas/elements/tabbed-notepad-element';
...
// Importar SuperNotebookElement para el tipo, aunque esté desactivado
import OldSuperNotebookElement from '@/components/canvas/elements/Old_super-notebook-element';
...
const ELEMENT_COMPONENTS: { [key in CanvasElement['type']]: React.FC<CommonElementProps> } = {
    ...
    'super-notebook': OldSuperNotebookElement, // DESACTIVADO TEMPORALMENTE - usando versión Old_
