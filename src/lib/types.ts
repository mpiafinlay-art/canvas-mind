...
export type ElementType =
  'image' | 'text' | 'sticky' | 'notepad' | 'notepad-simple' | 'super-notebook' | 'test-notepad' |
  'frame' | 'connector' | 'container' | 'comment' |
  'todo' |
  'drawing' |
  'moodboard' |
  'accordion' |
...
export interface TestNotepadCanvasElement extends BaseVisualProperties {
  type: 'test-notepad';
  hidden?: boolean;
  content: NotepadContent;
  minimized?: boolean;
...
export interface SuperNotebookCanvasElement extends BaseVisualProperties {
  type: 'super-notebook';
  hidden?: boolean;
  content: NotepadContent;
  minimized?: boolean;
...
export interface AccordionCanvasElement extends BaseVisualProperties {
  type: 'accordion';
  hidden?: boolean;
  content: AccordionContent;
}

export interface TabbedNotepadCanvasElement extends BaseVisualProperties {
  type: 'tabbed-notepad';
  hidden?: boolean;
  content: TabbedNotepadContent;
}
...
export type CanvasElement =
  ...
  | SuperNotebookCanvasElement
  | TestNotepadCanvasElement
  | FrameCanvasElement
  ...
  | AccordionCanvasElement
  | TabbedNotepadCanvasElement
